...
PREVIEW_PATH = 'QuickLookPreview.pdf'  # archive member path
pages_file: str = input('Enter the path to the .pages file in question: ')
...
if file_extension == ".pages":
    ...
    # delete the temporary subdirectory created (along with pdf file C:\Users\a-lhat\Desktop\Initial considerations following a personal data breach.pagesin it)
